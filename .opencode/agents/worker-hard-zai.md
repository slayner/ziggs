---
description: HARD tier worker (zai-coding-plan/glm-5.2). Substantial/mature/sensitive work, design choices, migrations. Invoked by the orchestrator when a task needs a strong model.
mode: subagent
