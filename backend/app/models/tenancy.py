...
class GuildAlbionLink(Base, TimestampMixin):
    ...
    # Albion e confirmou que a guilda existe. False = verificado e não
    # encontrado. Null = ainda não verificado (acabou de ser adicionado).
    verified: Mapped[bool | None] = mapped_column(Boolean, nullable=True, server_default=None)
