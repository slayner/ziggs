...
T: dict[str, dict[str, str]] = {
    ...
    "tx_action_forfeit_actor": {
        "pt": "{actor} confiscou {amount} do saldo de {target}",
        "en": "{actor} forfeited {amount} from {target}'s balance",
        "es": "{actor} confiscó {amount} del saldo de {target}",
    },
    "tx_action_split": {"pt": "Split de {event} para {target}", "en": "Split from {event} for {target}", "es": "Split de {event} para {target}"},
    "tx_action_scout": {"pt": "Scout de {event} para {target}", "en": "Scout from {event} for {target}", "es": "Scout de {event} para {target}"},
    "tx_action_logger": {"pt": "Logs de {event} para {target}", "en": "Logs from {event} for {target}", "es": "Logs de {event} para {target}"},
    "tx_action_regear": {"pt": "Regear de {event} para {target}", "en": "Regear from {event} for {target}", "es": "Regear de {event} para {target}"},
    "tx_action_payout": {"pt": "Pagamento de {event} para {target}", "en": "Payout from {event} for {target}", "es": "Pago de {event} para {target}"},
    "tx_action_event_deficit": {
        "pt": "Déficit de {event} para {target}",
        "en": "Deficit from {event} for {target}",
        "es": "Déficit de {event} para {target}",
    },
    "tx_detail_split": {"pt": "Distribuição do loot do evento", "en": "Event loot distribution", "es": "Distribución del loot del evento"},
    "tx_detail_logger": {"pt": "{percent}% dos logs enviados no evento", "en": "{percent}% of logs submitted for the event", "es": "{percent}% de los logs enviados en el evento"},
    "tx_detail_deficit": {"pt": "Distribuição do prejuízo do evento", "en": "Event loss distribution", "es": "Distribución de la pérdida del evento"},
    "tx_kind_unknown": {
        "pt": "Ação: {kind}",
        "en": "Action: {kind}",
        "es": "Acción: {kind}",
    ...
    "regear_payment_title": {"pt": "Pagamento de regear #{request_id}", "en": "Regear payment #{request_id}", "es": "Pago de regear #{request_id}"},
    "regear_payment_requester": {"pt": "Solicitante", "en": "Requester", "es": "Solicitante"},
    "regear_payment_event": {"pt": "Evento", "en": "Event", "es": "Evento"},
    "regear_payment_role": {"pt": "Cargo", "en": "Role", "es": "Rol"},
    "regear_payment_attendance": {"pt": "Presença", "en": "Attendance", "es": "Asistencia"},
    "regear_payment_parts": {"pt": "Peças", "en": "Items", "es": "Piezas"},
    "regear_payment_silver": {"pt": "Prata", "en": "Silver", "es": "Plata"},
    "regear_payment_identifier": {"pt": "Identificador", "en": "Identifier", "es": "Identificador"},
    "regear_modal_price_title": {"pt": "Alterar preço do item", "en": "Change item price", "es": "Cambiar precio del artículo"},
    "regear_modal_price_label": {"pt": "Índice,valor", "en": "Index,value", "es": "Índice,valor"},
    "regear_payment_select_placeholder": {"pt": "Regear", "en": "Regear", "es": "Regear"},
    "regear_payment_action_price": {"pt": "Alterar preço do item", "en": "Change item price", "es": "Cambiar precio del artículo"},
    "regear_payment_action_role": {"pt": "Alterar cargo", "en": "Change role", "es": "Cambiar rol"},
    "regear_payment_action_attendance": {"pt": "Alterar participação", "en": "Change participation", "es": "Cambiar participación"},
    "regear_payment_action_confirm": {"pt": "Confirmar pagamento", "en": "Confirm payment", "es": "Confirmar pago"},
    "regear_price_format_invalid": {
        "pt": "⚠️ Informe `índice,valor` (por exemplo, `1,250000`) com um índice válido e valor não negativo.",
        "en": "⚠️ Enter `index,value` (for example, `1,250000`) with a valid index and non-negative value.",
        "es": "⚠️ Indica `índice,valor` (por ejemplo, `1,250000`) con un índice válido y valor no negativo.",
    },
    "regear_payment_updated": {"pt": "✅ Pagamento atualizado.", "en": "✅ Payment updated.", "es": "✅ Pago actualizado."},
    "regear_payment_confirmed": {"pt": "✅ Pagamento confirmado.", "en": "✅ Payment confirmed.", "es": "✅ Pago confirmado."},
    "regear_payment_update_failed": {
        "pt": "⚠️ Não foi possível atualizar o pagamento. Verifique sua permissão e tente novamente.",
        "en": "⚠️ Could not update the payment. Check your permission and try again.",
        "es": "⚠️ No se pudo actualizar el pago. Comprueba tu permiso e inténtalo de nuevo.",
    },
    "regear_role_unavailable": {
        "pt": "⚠️ O backend ainda não permite alterar o cargo registrado neste pedido.",
        "en": "⚠️ The backend does not yet allow changing the role recorded on this request.",
        "es": "⚠️ El backend todavía no permite cambiar el rol registrado en esta solicitud.",
    },
    "regear_attendance_unavailable": {
        "pt": "⚠️ O backend ainda não permite alterar a participação registrada neste pedido.",
        "en": "⚠️ The backend does not yet allow changing the attendance recorded on this request.",
        "es": "⚠️ El backend todavía no permite cambiar la participación registrada en esta solicitud.",
    },
    "regear_event_action_unavailable": {
        "pt": "⚠️ Esta alteração só está disponível para regears vinculados a evento.",
        "en": "⚠️ This change is only available for event-linked regears.",
        "es": "⚠️ Este cambio solo está disponible para regears vinculados a un evento.",
    },
    ...
    "profile_progress_warm": {
        "pt": "🔎 Consultando o perfil de **{name}** em **{region}**…",
        "en": "🔎 Looking up **{name}** in **{region}**…",
        "es": "🔎 Consultando el perfil de **{name}** en **{region}**…",
    },
    "profile_progress_loading": {
        "pt": "📡 Perfil localizado. Carregando dados da API do Albion…",
        "en": "📡 Profile found. Loading data from Albion's API…",
        "es": "📡 Perfil localizado. Cargando datos de la API de Albion…",
    },
    "profile_progress_rendering": {
        "pt": "🖼️ Dados prontos. Preparando o preview do perfil…",
        "en": "🖼️ Data ready. Preparing the profile preview…",
        "es": "🖼️ Datos listos. Preparando la vista previa del perfil…",
    },
    "profile_link_ready": {
        "pt": "✅ Perfil de **{name}** pronto: {url}",
        "en": "✅ **{name}**'s profile is ready: {url}",
        "es": "✅ Perfil de **{name}** listo: {url}",
    },
    "profile_link_refreshed": {
        "pt": "✅ Perfil de **{name}** atualizado: {url}",
        "en": "✅ **{name}**'s profile was updated: {url}",
        "es": "✅ Perfil de **{name}** actualizado: {url}",
    },
